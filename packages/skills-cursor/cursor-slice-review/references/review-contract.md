...
This skill assumes the implementation was guided by a plan with task-level structure close to `cursor-plan-handoff` (or a compatible dense handoff-style markdown artifact).
