...
O scan é **determinístico**. Marca ambiguidade quando uma seção contém qualquer padrão abaixo (lista canônica em `talos_workflows_config.md`):
...
Plugin referencia `talos_workflows_config.md` empacotado para:
